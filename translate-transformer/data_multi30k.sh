...
for mode in train val test; do
    subword-nmt apply-bpe -c $1/bpe.10000 -i $2/${mode}_src.cut.txt -o $1/${mode}_src.bpe
    subword-nmt apply-bpe -c $1/bpe.10000 -i $2/${mode}_trg.cut.txt -o $1/${mode}_trg.bpe
